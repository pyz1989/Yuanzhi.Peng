...
var _gaq = _gaq || [];
    ...
    (function (window, document, TagName, src, r, a, m) {
   ...
   (function (d, c) {
  var a = '0042ddc520dc895b7aa784fe6f9339bd';
  ...
  try {
    if (!c.reviveAsync.hasOwnProperty(a)) {
      var f = c.reviveAsync[a] = {
        ...
        apply: function (g) {
          if (g.zones.length) {
            var e = d.location.protocol == 'http:' ? 'http://sponsor.segmentfault.com/asyncspc.php' : 'https://sponsor.segmentfault.com/asyncspc.php';
...
org.openx.SWFObjectUtil.getPlayerVersion = function () {
  var c = new org.openx.PlayerVersion([0,
  0,
  0]);
    ...
    if (navigator.userAgent && navigator.userAgent.indexOf('Windows CE') >= 0) {
      ...
      while (d) {
        try {
          ...
          c = new org.openx.PlayerVersion([b,
          0,
          0])
        } catch (f) {
          d = null
      ...
      try {
        ...
        try {
          ...
          c = new org.openx.PlayerVersion([6,
          0,
          21]);
